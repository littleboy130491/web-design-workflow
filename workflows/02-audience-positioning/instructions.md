...
Turn the strategic brief into concrete audience insight and a defensible market position that can drive narrative, proof, calls to action, and design emphasis.
...
- `decision-drivers.md`: Ranking of the criteria that most influence trust and conversion

## Success Criteria

- Audience segments are specific enough to influence copy and layout choices
- Differentiators are concrete and not generic category language
- Objections and trust gaps are explicit
- Positioning is usable as a decision filter for later steps
